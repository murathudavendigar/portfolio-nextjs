...
const BackgroundCircles = (props: Props) => {
  return (
    <motion.div
      ...
      <div className="absolute border border-[#CA3E47] rounded-full opacity-20 h-[650px] w-[650px]  mt-52 animate-pulse" />
      <div className="absolute border border-[#525252] rounded-full h-[800px] w-[800px] mt-52 animate-pulse" />
    </motion.div>
  );
};
