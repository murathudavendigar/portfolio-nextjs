...
export const AnimatedThemeToggler = ({
  ...
  return (
    <button
      ...
      {...props}
    >
      {/* Inverted vs. the vendor default: on this site next-themes `dark`
          (`.dark`) is the paper look, so the paper page offers the Moon and
          the charcoal page offers the Sun. */}
      {isDark ? <Moon /> : <Sun />}
